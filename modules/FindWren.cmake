...
if(NOT TARGET Wren)
  ...
  find_path(WREN_OPTIONAL_RANDOM_DIR NAMES wren_opt_random.h PATHS ${CMAKE_CURRENT_LIST_DIR}/../libs/wren/src/optional)
  mark_as_advanced(FORCE WREN_INCLUDE_DIR)
  mark_as_advanced(FORCE WREN_OPTIONAL_RANDOM_DIR)
